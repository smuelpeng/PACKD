...
def get_data_folder():
    ...
    data_folder = '/mnt/lustre/share/prototype_cifar/cifar100/'
    if not os.path.exists(data_folder):
        data_folder = '/mnt/lustreold/share/prototype_cifar/cifar100/'
...
class CIFAR100InstanceSampleMPKD(CIFAR100InstanceSample):
    """
    CIFAR100Instance+Sample Dataset
    """
...
def get_cifar100_dataloaders_sample(batch_size=128, num_workers=3, k=4096,
    ...
    if loader_type == "MPKD":
        train_set = CIFAR100InstanceSampleMPKD(root=data_folder,
                                               download=True,
                                               train=True,
                                               transform=train_transform,
                                               k=k,

...
class PACKDConLoss(nn.Module):
    ...
    def forward(self, feat_s, feat_t, labels=None, mask=None, contrast_idx=None,
        ...
        # calculate crd loss
        criterion_crd = ContrastNCELoss(self.n_data, self.mixup_num)
